...
angular.module('risevision.common.svg.icons', [])
  .constant('iconsList', {
    icons1: { 
      ...
      riseStatOffline:"M28.61,8.77H13.92L11,6.16a0.85,0.85,0,0,0-.57-0.22H3.67a0.88,0.88,0,0,0-1,.71V24.22a1.11,1.11,0,0,0,1,1H28.61a0.88,0.88,0,0,0,.71-1V9.48A0.63,0.63,0,0,0,28.61,8.77Z",
      riseStatOnline:"M16.1,30.7C7.9,30.7,1.4,24.1,1.4,16S7.9,1.2,16.1,1.2S30.8,7.8,30.8,16S24.2,30.7,16.1,30.7z M16.1,4.2 C9.6,4.2,4.3,9.5,4.3,16s5.3,11.8,11.8,11.8S27.8,22.4,27.8,16S22.6,4.2,16.1,4.2z M8.7,16l2.1-2.1l3.8,3.8l6.8-6.8l2.1,2.1 l-8.8,8.8L8.7,16z"
    },
    icons2: { 
      riseLogo: "",
